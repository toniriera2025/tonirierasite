...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for toniriera-images" ON storage.objects FOR SELECT USING (bucket_id = 'toniriera-images');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for toniriera-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'toniriera-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for toniriera-images" ON storage.objects FOR UPDATE USING (bucket_id = 'toniriera-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for toniriera-images" ON storage.objects FOR DELETE USING (bucket_id = 'toniriera-images');`
    ];
