...
COMMENT ON COLUMN projects.title_es IS 'Project title in Spanish';
COMMENT ON COLUMN projects.title_ca IS 'Project title in Catalan';
COMMENT ON COLUMN projects.description_en IS 'Project description in English';
COMMENT ON COLUMN projects.description_es IS 'Project description in Spanish';
COMMENT ON COLUMN projects.description_ca IS 'Project description in Catalan';
COMMENT ON COLUMN projects.default_language IS 'Primary language for this project';
COMMENT ON COLUMN projects.translation_status IS 'Translation completion status for each language';